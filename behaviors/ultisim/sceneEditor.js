class TransformControls {
  ...
  setup() {
    var trCt = this.makeTransformControls(Worldcore.THREE)
    // var geometry = new WorldCore.THREE.BoxGeometry( 200, 200, 200 );
    // var material = new WorldCore.THREE.MeshLambertMaterial( { map: texture } );

    // control      = new WorldCore.THREE.TransformControls( camera, renderer.domElement );
    // control.addEventListener( 'change', render );

    // var mesh     = new WorldCore.THREE.Mesh( geometry, material );
    // scene.add( mesh );
...
export default {
  modules: [{
    ...
    actorBehaviors: [TransformControls],
  }]
}
